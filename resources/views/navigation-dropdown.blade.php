            ...
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="/dashboard/2">
                        ...
                        <!-- <img src="noun_Library_191.png" alt="..."> -->
                    </a>
                </div>

                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="/dashboard/2" :active="request()->routeIs('dashboard')">
                        {{ __('My Dashboard') }}
                    </x-jet-nav-link>

                    <x-jet-nav-link href="/allbooks" :active="request()->routeIs('dashboard')">
                        {{ __('All Books') }}
                    </x-jet-nav-link>
                </div>
            </div>
